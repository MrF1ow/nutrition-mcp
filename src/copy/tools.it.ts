...
export const TOOLS_IT: ToolsDoc = {
    meta: {
        title: "Guida agli strumenti: tutti i 42 strumenti",
        description:
            "Tutti i 42 strumenti che il server Nutrition MCP mette a disposizione della tua IA — registra i pasti, scansiona codici a barre, importa il tuo storico da un'altra app, monitora acqua e peso, imposta obiettivi e rivedi gli andamenti. Guida completa con descrizioni ed esempi di richieste.",
        ogDescription:
            "Tutti i 42 strumenti che il server Nutrition MCP mette a disposizione della tua IA, incluso un importatore CSV per il tuo storico da un'altra app — con descrizioni ed esempi di richieste.",
    },
    hero: {
    ...
    tools: {
        ...
        add_household_member: {
            description:
                "Aggiunge un membro della famiglia come vero utente Auth. Passa display_name, password e email oppure username. Uno username diventa {username}@household.invalid. La nuova riga è sempre member, non owner. Restituisce il nuovo user_id così il bot familiare può registrare per quella persona. Non invia email di invito. Usa lo stesso SUPABASE_SECRET_KEY che il server già richiede.",
            params: {
                display_name: "Nome salvato su household_members",
                password: "Almeno 8 caratteri",
                email: "Login con email reale. Usa questo o username, non entrambi.",
                username:
                    "Login salvato come <code>{username}@household.invalid</code>. Usa questo o email, non entrambi.",
            },
            example: "Aggiungi Sam come username sam con password password1",
        },
