...
export const INDEX_IT: IndexDoc = {
    ...
    onboarding: {
        ...
        toolsCta: {
            ...
            body: "Sfoglia tutti i 41 strumenti — registrazione, codici a barre, acqua, peso, obiettivi e andamenti — con una descrizione e un esempio di richiesta per ciascuno.",
