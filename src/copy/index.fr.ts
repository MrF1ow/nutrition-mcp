...
export const INDEX_FR: IndexDoc = {
    ...
    onboarding: {
        ...
        toolsCta: {
            ...
            body: "Parcours les 42 outils — enregistrement, codes-barres, eau, poids, objectifs et tendances — avec une description et un exemple de formulation pour chacun.",
